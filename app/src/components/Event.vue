...
import type { OEF_Event } from '@resenha/oef/types';
import ImageDialog from './ImageDialog.vue';

const event = defineModel({
    type: Object as PropType<OEF_Event>,
    required: true
});
...
const tab = ref();
const bgImg = ref('https://imgs.search.brave.com/Q2YBpUsL-T5YeGp6cnVNOW-NTCBJ5iUqmPoeFO1Ip2c/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9naWxz/b25hemV2ZWRvLmNv/bS5ici93cC1jb250/ZW50L3VwbG9hZHMv/MjAyNS8wNC9QU0Qt/bmlnaHQtY2x1Yi1k/ai1wYXJ0eS1mbHll/ci1mZWVkLWRlc2ln/bi5qcGc');
